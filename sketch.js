...
//barra de vida
var barra_life_player, barra_life_monster, barra_life_image;
var barra_vermelha_player, barra_vermelha_monster;
...
function preload() {
  ...
  barra_life_image = loadImage("barra de vida.png");
...
function setup() {
  ...
  barra_vermelha_player = createSprite(165 , 110, 130, 15);
  barra_vermelha_player.shapeColor = "red";

  barlife_Player = createSprite(150 , 100);
  barlife_Player.addImage("barlife", barra_life_image);
  barlife_Player.scale = 2.0;

  barra_vermelha_monster = createSprite(1115 , 110, 130, 15);
  barra_vermelha_monster.shapeColor = "purple";

  barra_life_monster = createSprite(1100 , 100);
  barra_life_monster.addImage("barlife", barra_life_image);
  barra_life_monster.scale = 2.0;
